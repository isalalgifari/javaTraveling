            ...
            <q-item-section>
              <q-item-label>
                <router-link to="/admin/transaksi">
                   <q-btn color="primary" icon="shopping_cart" label="Transaksi" class="full-width" align="left"/>
                </router-link>
              ...
              <q-item-label>
                <router-link to="/admin/Produk">
                   <q-btn color="primary" icon="card_giftcard" label="Produk" class="full-width" align="left"/>
                </router-link>
              </q-item-label>
