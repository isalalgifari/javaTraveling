<template>
  ...
  <div class="row justify-center"> 
    <div class="text-h3 q-mx-auto q-pt-lg"> 
      <b> Destinasi</b><br>
      </br>
    </div>
    <q-card class="my-card">
    <div class="row justify-center"> 
      <q-btn id="padding" flat v-for="item in images" :key="item.id" style="min-width:200px; max-width:250px" @click="show(item)">
          <q-img style="width:400px; height:250px " class="q-mx-auto"
                              :src="item.imgurl">
